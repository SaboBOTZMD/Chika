...
*Q : Uang Donasi Mau Dipake Buat Apaan?*
*A : Buat Beli Apikey*
*Q : Apikey Apaan Bg?*
*A : Susah Jelasinnya Kalo Mau Tau Chat Owner Aja*
...
—————「 *SEWA | JADI BOT* 」—————
  ...
  *_SEWA BOT_* 
  *≻* Sewa Bot 5K (PERMINGGU)
  *≻* Sewa Bot 8K (PERBULAN)
  *≻* Sewa Bot 12K (PERMANEN)

  *JADI BOT* 
  *≻* Jadi Bot 15K Tidak Owner (PERMINGGU)
  *≻* Jadi Bot + Owner 20K (PERMINGGU)
  *≻* Jadi Bot + Owner 30K (PERBULAN)


  *Minat? Langsung Chat Owner!*
